    ...
    gebo_notifications = {
        sticky: function() {
            ...
            $('#sticky_c').click(function(e){
                $.sticky("Data Berhasil ditambah..", {autoclose : 5000, position: "top-right", type: "st-info" });
            });
		...
		smoke_js: function() {
			$('#smoke_signal').click(function(e){
                smoke.signal('Data Berhasil ditambahkan... 5 detik lagi akan meledak...');
				e.preventDefault();
            });
			$('#smoke_alert').click(function(e){
                smoke.alert('Yakin data ini hendak di hapus?...');
				e.preventDefault();
            });
