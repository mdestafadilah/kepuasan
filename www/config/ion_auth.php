 ...
 */
$config['site_title']           = "Sistem Kepuasan"; 		// Site Title, example.com
$config['admin_email']          = "admin@perawatku.com"; 	// Admin Email, admin@example.com
$config['default_group']        = 'members'; 			// Default group, use name
$config['admin_group']          = 'admin'; 				// Default administrators group, use name
$config['identity']             = 'username'; 				// A database column which is used to login with (email)
