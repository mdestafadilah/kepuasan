...
<html lang="en">
    <head>
        ...
        <?=js('jquery.min.js')?>
        <!-- GRAFIK ENGINE -->
		<script type="text/javascript" src="<?=asset_url();?>lib/highcharts/js/highcharts.js"></script>
                        ...
                        <div class="container-fluid">
                            ...
                            <li class="divider-vertical hidden-phone hidden-tablet"></li>
                            	<li class="dropdown">
                                	<div class="btn-group pull-right">
										<button class="btn btn-danger"><i class="icon-user icon-white"></i> <?php echo $welcome;?></button>
                            ...
                            <nav>
                                <div class="nav-collapse">
                                    <ul class="nav">
                                     <li>
                                     	<a href="<?=site_url('home');?>"><i class="icon-home icon-white"></i> Home</a>
                                     </li>
                                    <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle" href="#"> 
                                            <i class="splashy-view_list_with_thumbnail"></i> Master Data <b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="<?=site_url('perawat');?>"><i class="splashy-contact_grey"></i> Data Perawat</a></li>
                                                <li><a href="<?=site_url('pelanggan');?>"><i class="splashy-contact_grey"></i> Data Pelanggan</a></li>
                                                <li><a href="<?=site_url('soal')?>"><i class="splashy-document_letter"></i> Data Pertanyaan</a>
                                            	<li><a href="<?=site_url('kesimpulan')?>"><i class="splashy-document_letter"></i> Data Kesimpulan</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
