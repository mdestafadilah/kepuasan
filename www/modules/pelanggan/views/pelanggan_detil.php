<div class="row-fluid">
	<div class="span12">
		<h3 class="heading">Client Profile Detail</h3>
		<div class="row-fluid">
			<div class="span12">
				<div class="vcard">
					<img class="thumbnail" src="<?=img_url();?>none.jpg" alt="foto" />
					<?php
						//echo anchor('pelanggan/add_profile/'.$single['id'],'Update','');
					?>
					<ul>
						...
						<?php	
							echo "<span class='item-key'>Nama Depan</span>
					 		...
					 		<div class='vcard-item'>".'none';"</div></li>";
					 		
					 		echo "<li><span class='item-key'>Alamat</span>
					 		<div class='vcard-item'>".ucfirst($user->address)."</div></li>";
					 		?>
						</li>
						<li class="v-heading">Elderly Information</li>
						<li>
						<?php
							echo "<span class='item-key'>Nama Perawat</span>
					 		<div class='vcard-item'>".ucfirst($pasangan->nama_perawat)."</div>";
					 		echo "<li><span class='item-key'>Jenis Rawat</span>
					 		<div class='vcard-item'>".ucfirst($pasangan->jenis_rawat)."</div></li>";
					 		echo "<li><span class='item-key'>Email</span>
					 		<div class='vcard-item'>".ucfirst($pasangan->email_perawat)."</div></li>";
					 		echo "<li><span class='item-key'>No. Telephone</span>
					 		<div class='vcard-item'>".ucfirst($pasangan->telpon_perawat)."</div></li>";
					 		echo "<li><span class='item-key'>Alamat</span>
					 		<div class='vcard-item'>".ucfirst($pasangan->alamat_perawat)."</div></li>";
					 	?>
						</li>
