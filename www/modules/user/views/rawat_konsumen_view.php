<?php echo $message; ?>
<?php echo form_open('user/manajer/rawat_konsumen','class = "form-horizontal well"')?>
<fieldset>
	...
	<div class="control-group">
	 <div class="formSep">
			...
			<div class="controls">
				...
				<a href="<?=site_url('user/manajer/index');?>" class="btn">Cancel</a>
			</div>
			</div>
		</div>
</fieldset>
