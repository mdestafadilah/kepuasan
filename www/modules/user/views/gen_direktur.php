				...
				<div class="vcard">
					...
					<ul>
						...
						<li><span class="item-key">Level</span>
							<div class="vcard-item">Direktur</div>
						</li>
						<li><span class="item-key">Hak Akses:</span>
							<div class="vcard-item">
								<ul class="list_a">
									<li>Melihat Daftar Pelanggan</li>
									<li>Melihat Daftar Perawat</li>
									<li>Melihat Daftar Pertanyaan</li>
									<li>Mensetujui Pertanyaan</li>
									<li>Mensetujui Kesimpulan/ Saran</li>
								</ul>
							</div>
						</li>
