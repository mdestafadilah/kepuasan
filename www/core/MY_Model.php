 ...
 * 
 * 'user_activity_date' => date('Y-m-d H:i:s')));    type datetime
 */
...
class MY_Model extends CI_Model
{
	 ...
	 *   }
	 * 
	 * with this just put  cz RETURN AN OBJECT!
	 * 	$some = $this->some_model->get($id);
	 * call with specific fields
	 * 	$some->some_field;
	 *  $some->some_field2;
	 *  
	 * Document add by: @emang_dasar
     */
	 ...
	 * 
	 * sql: SELECT * FROM (`tbl_name`) WHERE `condition_feild`
     */
     ...
     * 
     * source	: http://stackoverflow.com/questions/12072418/my-model-by-jamie-rumbelow-how-to-use-where-with-the-model#comment20361005_12181317
     * used		: $this->news_model->get_many_by(array( 'key' => 'value', 'other_key' => 'value' ));
     * 
     ...
     * 
     * use in controller : $this->data['news'] = $this->news_model->active_news()->get_all();
     * $this->some_model->get_many_by('active',1);
     */
     ...
     * @package		CodeIgniter
 	 ...
 	 * -----
 	 * some littler modif with $table to $_table name
 	 * -----
 	 * use it : $this->mdl_name->paginate()->result()
 	 * result : object
     */
    public function paginate()
    {
    	...
    	$this->total_rows = $this->get($this->_table)->num_rows();
    	...
    	$this->query = $this->db->get($this->_table);
